...
imazu_scenarios = {
    ...
    16: [
        {"x": 0.000, "y": -6.000, "psi": 90.0, "u": 3.0},
        {"x": 0.000, "y": 6.000, "psi": -90.0, "u": 3.0},
        {"x": -2.970, "y": -2.970, "psi": 45.0, "u": 3.0}
    ],
    17: [
        {"x": -4.200, "y": 0.000, "psi": 0.0, "u": 2.1},
        {"x": -5.909, "y": -1.042, "psi": 10.0, "u": 3.0},
...
def generate_all_scenarios():
    ...
    output_dir = "/home/hyo/DRL-otter-navigation/robot_nav/worlds/verify_scenario"
    ...
    for case_num, target_ships in imazu_scenarios.items():
        ...
        # Write to file
        filename = f"{output_dir}/verify_case_{case_num:02d}.yaml"
