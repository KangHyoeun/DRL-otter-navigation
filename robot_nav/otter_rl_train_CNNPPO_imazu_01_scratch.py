...
def main():
    ...
    training_iterations = 50  # PPO epoch per update
    ...
    print("\n" + "=" * 60)
    print("🎯 IMAZU CASE COLLISION AVOIDANCE - SCRATCH LEARNING")
    print("=" * 60)
    print("   Environment: Imazu Case")
    print("   Start: (0, -90)")
    print("   Goal: (0, 90)")
    ...
    model = CNNPPO(
        ...
        model_name="otter_CNNPPO_imazu_01_scratch",  # ⭐ 새로운 모델 이름
    ...
    sim = OtterSIM(
        world_file="/worlds/imazu_scenario/imazu_case_01.yaml",  # ⭐ 90m 환경!
    ...
    while epoch < max_epochs:
        state, terminal = model.prepare_state(
            ...
            sim.start_position, sim.robot_goal, CR_max
        )
        ...
        if episode % episodes_per_epoch == 0 and episode > 0:
            ...
            if avg_reward > best_reward:
                ...
                model.save(filename="otter_CNNPPO_imazu_01_scratch_BEST", directory=best_dir)
                ...
                with open(best_dir / "best_metrics_imazu_scratch.json", 'w') as f:
    ...
    print(f"   Model name:            otter_CNNPPO_imazu_01_scratch_BEST")
    print("=" * 60)
