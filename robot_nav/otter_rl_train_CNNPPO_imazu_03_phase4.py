...
def main():
    ...
    gamma = 0.995
    eps_clip = 0.2
    action_std_init = 0.3  # Rely more on learned policy in complex scenarios
    action_std_decay_rate = 0.015  
    min_action_std = 0.1
    
    # Model names
    phase3_model_name = "otter_CNNPPO_imazu_02_phase3_BEST"
    phase4_model_name = "otter_CNNPPO_imazu_03_phase4"
    ...
    writer = SummaryWriter(log_dir=f"runs/{phase4_model_name}")
    ...
    for epoch in range(max_epochs):
        ...
        if avg_reward > best_avg_reward:
            ...
            patience_counter = 0
            model.save(Path("robot_nav/models/PPO/best_checkpoint"), f"{phase4_model_name}_BEST")
